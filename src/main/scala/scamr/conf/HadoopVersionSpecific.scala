...
object HadoopVersionSpecific {
  import scamr.Version.{Cdh3, Cdh4, Cdh5}
  ...
  def isNativeSnappyLoaded(conf: Configuration): Boolean = {
    try {
      ...
      } else if (scamr.Version.isCdh4 || scamr.Version.isCdh5) {
